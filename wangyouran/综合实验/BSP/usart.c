...
USART_Cmd(USART2, ENABLE); // enable USART2 (polling mode, no RXNE interrupt)
}
...
/* USART2 IRQ removed - fgetc() polls RXNE directly.
   QCOM provides local echo, no MCU-side echo needed. */